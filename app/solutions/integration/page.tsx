  ...
  return (
    <div className="relative">
      <div className="container mx-auto mb-32">
        ...
        />
        <Contact
          highlightTitle="artwork systems?"
          title1="Ready to connect your "
          title2=""
          description="Explore how 5Flow’s Integration solution unifies your tools, cuts errors, and makes workflows seamless."
