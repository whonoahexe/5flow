    ...
    <div className="relative">
      <div className="container mx-auto mb-32">
        ...
        <Workflow
          ...
          subtitle="Content that scales without errors"
        ...
        />
        <Contact
          highlightTitle="start feeling"
          title1="Prepared to "
          title2="content?"
          description="Discover how 5Flow’s Content Management solution centralizes data, simplifies approvals, and accelerates global launches."
