...
interface ProductHeroServerProps {
  slug: string; // WP page slug expected to match route segment
  fallback: HeroProps;
}

export default async function ProductHeroServer({ slug, fallback }: ProductHeroServerProps) {
