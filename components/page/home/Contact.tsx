...
const Contact: NextPage = () => (
  <div className="text-foreground font-heading relative box-border flex w-full flex-col items-stretch pt-16 text-left text-6xl">
    <FullBleedLines>
      <div className="relative w-full">
        ...
        <div className="font-body left-0 flex w-full items-center justify-between py-0 text-sm">
          ...
          <div className="bg-primary relative right-0 flex h-144 w-144 items-center justify-end rounded-2xl">
