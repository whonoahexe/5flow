...
export function Contact({
  ...
  // Validators (match page/contact/Form.tsx behavior)
        ...
        <div className="relative w-full">
          <div className="bg-primary relative flex w-full flex-col items-center justify-between overflow-hidden rounded-2xl px-4 py-8 md:flex-row md:items-center md:px-16 md:py-12">
            <form
              ...
              className="z-20 flex w-full max-w-4xl flex-col items-center justify-center gap-6 md:items-end"
            >
              ...
              {Object.values(errors).filter(Boolean).length > 0 && (
                <div className="border-destructive/30 bg-destructive/10 text-destructive w-full rounded-md border p-3 text-xs sm:text-sm">
              ...
              {/* Navigation & Terms */}
              <div className="text-background flex w-full flex-col gap-4 md:flex-row md:items-start md:justify-between">
                {step === 2 ? (
